...
TypoReporter.prototype.render = function () {
	...
	return state.isOpen && (0, _el2.default)('div', {}, [(0, _el2.default)('div', { class: 'ReportTypo-overlay', onClick: this.closeDialog }), (0, _el2.default)('div', { class: 'ReportTypo' }, [(0, _el2.default)('button', { type: 'button', class: 'ReportTypo-cancel', onClick: this.closeDialog }), (0, _el2.default)('div', { class: 'ReportTypo-header' }, i18n.header), (0, _el2.default)('div', { class: 'ReportTypo-label' }, i18n.messageLabel), (0, _el2.default)('div', { class: 'ReportTypo-message' }, state.snippet.replace('>>>', '<u class="ReportTypo-heighlight">').replace('<<<', '</u>')), (0, _el2.default)('div', { class: 'ReportTypo-comment-container' }, [(0, _el2.default)('textarea', {
		class: 'ReportTypo-comment',
		onKeyup: this.handleCommentChange,
		placeholder: this.props.messagePlaceholder
	}, state.comment)]), (0, _el2.default)('div', { class: 'ReportTypo-label' }, i18n.commentLabel), (0, _el2.default)('div', { class: 'ReportTypo-submit-container' }, [(0, _el2.default)('button', { type: 'button', class: 'ReportTypo-submit', onClick: this.submit }, state.isSending ? i18n.sending : i18n.send)]), (0, _el2.default)('div', null, state.isError && i18n.error)])]);
};
